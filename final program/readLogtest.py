...
setup_logger('log1', PatientTest1+IDD1+'.log')
setup_logger('log2', PatientTest2+IDD2+'.log')
setup_logger('log3', PatientTest3+IDD3+'.log')
...
def Main():
    Counter = -1
    balls = input("Choose Patient || press y for patient index Or enter patient name:  ")
    if(balls == "y"):
